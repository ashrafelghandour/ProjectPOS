    ...
    public partial class frmAddNewSupplier : Form
    {
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (context.Suppliers.Any(s => s.Phone == Phone.Text && s.Name == tbName.Text))
                    {
                        MessageBox.Show("this supplier is exthist", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        return;
                    }
